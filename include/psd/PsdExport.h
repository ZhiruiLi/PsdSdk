...
PSD_API ExportDocument* CreateExportDocument(Allocator* allocator, unsigned int canvasWidth, unsigned int canvasHeight, unsigned int bitsPerChannel, exportColorMode::Enum colorMode);

/// \ingroup Exporter
/// Destroys and nullifies the given \a document previously created by a call to \ref CreateExportDocument.
PSD_API void DestroyExportDocument(ExportDocument*& document, Allocator* allocator);
...
PSD_API unsigned int AddMetaData(ExportDocument* document, Allocator* allocator, const char* name, const char* value);

/// \ingroup Exporter
/// Updates existing meta data at the given \a index.
PSD_API void UpdateMetaData(ExportDocument* document, Allocator* allocator, unsigned int index, const char* name, const char* value);

/// \ingroup Exporter
/// Sets the ICC profile of a document. The contents of \a rawProfileData are copied.
PSD_API void SetICCProfile(ExportDocument* document, Allocator* allocator, void* rawProfileData, uint32_t size);

/// \ingroup Exporter
/// Sets the EXIF data of a document. The contents of \a rawExitData are copied.
PSD_API void SetEXIFData(ExportDocument* document, Allocator* allocator, void* rawExifData, uint32_t size);

/// \ingroup Exporter
/// Sets the JPEG thumbnail of a document. The contents of \a rawJpegData are copied.
PSD_API void SetJpegThumbnail(ExportDocument* document, Allocator* allocator, uint32_t width, uint32_t height, void* rawJpegData, uint32_t size);


/// \ingroup Exporter
/// Adds a layer to a document. The returned index can be used to update layer data by a call to \ref UpdateLayer.
PSD_API unsigned int AddLayer(ExportDocument* document, Allocator* allocator, const char* name);
...
PSD_API void UpdateLayer(ExportDocument* document, Allocator* allocator, unsigned int layerIndex, exportChannel::Enum channel, int left, int top, int right, int bottom, const uint8_t* planarData, compressionType::Enum compression);
...
/// Note that individual layers can be smaller and/or larger than the canvas in PSD documents.
PSD_API void UpdateLayer(ExportDocument* document, Allocator* allocator, unsigned int layerIndex, exportChannel::Enum channel, int left, int top, int right, int bottom, const uint16_t* planarData, compressionType::Enum compression);
...
/// Note that individual layers can be smaller and/or larger than the canvas in PSD documents.
PSD_API void UpdateLayer(ExportDocument* document, Allocator* allocator, unsigned int layerIndex, exportChannel::Enum channel, int left, int top, int right, int bottom, const float32_t* planarData, compressionType::Enum compression);

/// \ingroup Exporter
/// Adds an alpha channel to a document. The returned index can be used to update channel data by a call to \ref UpdateChannel.
PSD_API unsigned int AddAlphaChannel(ExportDocument* document, Allocator* allocator, const char* name, uint16_t r, uint16_t g, uint16_t b, uint16_t a, uint16_t opacity, AlphaChannel::Mode::Enum mode);
...
PSD_API void UpdateChannel(ExportDocument* document, Allocator* allocator, unsigned int channelIndex, const uint8_t* data);
...
PSD_API void UpdateChannel(ExportDocument* document, Allocator* allocator, unsigned int channelIndex, const uint16_t* data);
...
PSD_API void UpdateChannel(ExportDocument* document, Allocator* allocator, unsigned int channelIndex, const float32_t* data);
...
PSD_API void UpdateMergedImage(ExportDocument* document, Allocator* allocator, const uint8_t* planarDataR, const uint8_t* planarDataG, const uint8_t* planarDataB);

/// \ingroup Exporter
/// Updates the merged image data. The function internally takes ownership over all data, so planar image data passed to this function can be freed afterwards.
/// Planar data must hold width*height*2 bytes.
PSD_API void UpdateMergedImage(ExportDocument* document, Allocator* allocator, const uint16_t* planarDataR, const uint16_t* planarDataG, const uint16_t* planarDataB);

/// \ingroup Exporter
/// Updates the merged image data. The function internally takes ownership over all data, so planar image data passed to this function can be freed afterwards.
/// Planar data must hold width*height*4 bytes.
PSD_API void UpdateMergedImage(ExportDocument* document, Allocator* allocator, const float32_t* planarDataR, const float32_t* planarDataG, const float32_t* planarDataB);

/// \ingroup Exporter
/// Exports a document to the given file.
PSD_API void WriteDocument(ExportDocument* document, Allocator* allocator, File* file);
